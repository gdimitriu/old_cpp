// shapes_win32.cpp : Defines the entry point for the application.
//

#include "stdafx.h"
#include "shapes_win32.h"
#include "CmyPoint.h"
#include "Line.h"
#include "Rectangle.h"
#include "Shapes.h"
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_SHAPES_WIN32, szWindowClass, MAX_LOADSTRING);
	...
	hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_SHAPES_WIN32));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon			= LoadIcon(hInstance, MAKEINTRESOURCE(IDI_SHAPES_WIN32));
	wcex.hCursor		= LoadCursor(NULL, IDC_ARROW);
	wcex.hbrBackground	= (HBRUSH)(COLOR_WINDOW+1);
	wcex.lpszMenuName	= MAKEINTRESOURCE(IDC_SHAPES_WIN32);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	CGraphicalInterface m_graphical;
